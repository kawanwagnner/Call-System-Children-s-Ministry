...
export function HomePage({
  onNavigate,
  onTabChange,
  activeTab: propActiveTab = "ministerio",
}: HomePageProps) {
  const [activeTab, setActiveTab] = useState<TabType>(propActiveTab);
  const [showLessonForm, setShowLessonForm] = useState(false);

  // React Query hook para estatísticas
  const { data: stats, isLoading: loading } = useDashboardStats(activeTab);
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between py-3 border-b border-gray-100">
                ...
                <div className="text-sm text-gray-400">1 presenças</div>
              </div>
              <div className="flex items-center justify-between py-3 border-b border-gray-100">
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
  ...
  const renderRecepcaoContent = () => (
    <div className="space-y-8">
      {/* Header */}
      <div className="text-center">
        <h1 className="text-4xl font-bold text-gray-900 mb-2">Recepção</h1>
        <p className="text-lg text-gray-600 flex items-center justify-center gap-2">
          <Calendar size={20} />
          Sistema de Chamadas
        </p>
            ...
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Membro • Check-in: 14:30
                  </p>
                </div>
              </div>
              <div className="text-sm text-teal-600 font-medium">Presente</div>
            </div>
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Visitante • Check-in: 14:25
                  </p>
                </div>
              </div>
              <div className="text-sm text-indigo-600 font-medium">Nova</div>
            </div>
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tab Content */}
      {activeTab === "ministerio"
        ? renderMinisterioContent()
        : renderRecepcaoContent()}
